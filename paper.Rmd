...
models <- list(homclass,full1,rob2,int_homo)
...
m1_df <-
    broom.mixed::tidy(rob1) %>% filter(term %in%  c("class3Intermediate class (III+IV)",
...
giniD_rs <-update(base, . ~ . - (1|country2) + (homclass|country2))
