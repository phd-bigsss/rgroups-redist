...
full <- lmer(redist~1 +female+agenum + class3 +edyears+homclass+Q05pcm+(1|country2),data=dfreg)
# Interactions segregation x class
full_int1 <- lmer(redist~1 +female+agenum + edyears + Q05pcm + homclass*class3 +(1|country2),data=dfreg)
...
omitcoef <- "(Intercept)|(agenum)|(female)|(Q05pcm)|(edyears)|(logrgdpna)"
