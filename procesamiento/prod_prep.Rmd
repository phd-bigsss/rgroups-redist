...
sjlabelled::set_label(df1$pi_nteg) <- "Perceived integration"
```
...
df1$eindex_s<- (df1$outgroup_s-df1$ingroup_s)/(df1$outgroup_s+df1$ingroup_s)
...
df1$eindex_w<- (df1$outgroup_w-df1$ingroup_w)/(df1$outgroup_w+df1$ingroup_w)
...
df1$eindex_res<- (df1$outgroup_res-df1$ingroup_res)/(df1$outgroup_res+df1$ingroup_res)
