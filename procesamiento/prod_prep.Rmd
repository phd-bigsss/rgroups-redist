...
df1$oesch16 <- as_labelled(df1$oesch16)
df1$oesch16spo <- as_labelled(df1$oesch16spo)
# # Upper-middle class
#  [1] "'Large employers'"
...
df1$oesch3res <- car::recode(df1$oesch16,recode="c(1,2,9,10,5,6,13,14)=1;c(3,4,11)=2;c(7,8,12,15,16)=3")
df1$oesch3spo <- car::recode(df1$oesch16spo,recode="c(1,2,9,10,5,6,13,14)=1;c(3,4,11)=2;c(7,8,12,15,16)=3")

sjPlot::tab_xtab(df1$oesch3res,df1$oesch3spo,show.na = T)
```
