...
save(list = models,file = here::here("output/fullsample-logit-homclass-full-individual.RData"))
...
customcoef <- 
  list(
    ...
    giniindex = "Gini (World Bank)",
    "homclass:giniindex" = "Homogeneity x Gini (WB)",
...
save(list = list(giniD_gdp,giniD_rs,giniD_int,
                 giniM_gdp,giniM_rs,giniM_int,
                 int_palma,int_pc10,int_pc50,int_d10d1,
                 int_gini_wiid,int_theil),
     file = here::here("output/fullsample-logit-homclass-full-macro.RData"))
```
...
models <- list(homclass,full1,rob1,int_homo)
save(list = models,file = here::here("output/fullsample-logit-homclass-strong-individual.RData"))
texreg::knitreg(models,caption=paste("(\\#tab:modredist)",cap1),caption.above=T,
                                float.pos="h!",
                  include.thresholds=FALSE,
                  custom.coef.map=coefmap,
...
save(list = list(giniD_gdp,giniD_rs,giniD_int,
                 ...
                 int_palma,int_pc10,int_pc50,int_d10d1,
                 int_gini_wiid,int_theil),
     file = here::here("output/fullsample-logit-homclass-strong-macro.RData"))
```
...
models <- list(homclass,full1,rob1,int_homo)
save(list = models,file = here::here("output/fullsample-logit-homclass-weak-individual.RData"))
texreg::knitreg(models,caption=paste("(\\#tab:modredist)",cap1),caption.above=T,
                                float.pos="h!",
                  include.thresholds=FALSE,
                  custom.coef.map=coefmap,
...
save(list = list(giniD_gdp,giniD_rs,giniD_int,
                 ...
                 int_palma,int_pc10,int_pc50,int_d10d1,
                 int_gini_wiid,int_theil),
     file = here::here("output/fullsample-logit-homclass-weak-macro.RData"))
```
...
models <- list(homclass,full1,rob1,int_homo)
save(list = models,file = here::here("output/fullsample-ologit-homclass-full-individual.RData"))
texreg::knitreg(models,caption=paste("(\\#tab:modredist)",cap1),caption.above=T,
                                float.pos="h!",
                  include.thresholds=FALSE,
                  custom.coef.map=coefmap,
...
save(list = list(giniD_gdp,giniD_rs,giniD_int,
                 ...
                 int_palma,int_pc10,int_pc50,int_d10d1,
                 int_gini_wiid,int_theil),
     file = here::here("output/fullsample-ologit-homclass-full-macro.RData"))
```
...
models <- list(homclass,full1,rob1,int_homo)
save(list = models,file = here::here("output/fullsample-ologit-homclass-strong-individual.RData"))
texreg::knitreg(models,caption=paste("(\\#tab:modredist)",cap1),caption.above=T,
                                float.pos="h!",
                  include.thresholds=FALSE,
                  custom.coef.map=coefmap,
...
save(list = list(giniD_gdp,giniD_rs,giniD_int,
                 ...
                 int_palma,int_pc10,int_pc50,int_d10d1,
                 int_gini_wiid,int_theil),
     file = here::here("output/fullsample-ologit-homclass-strong-macro.RData"))
```
...
models <- list(homclass,full1,rob1,int_homo)
save(list = models,file = here::here("output/fullsample-ologit-homclass-weak-individual.RData"))
texreg::knitreg(models,caption=paste("(\\#tab:modredist)",cap1),caption.above=T,
                                float.pos="h!",
                  include.thresholds=FALSE,
                  custom.coef.map=coefmap,
...
save(list = list(giniD_gdp,giniD_rs,giniD_int,
                 ...
                 int_palma,int_pc10,int_pc50,int_d10d1,
                 int_gini_wiid,int_theil),
     file = here::here("output/fullsample-ologit-homclass-weak-macro.RData"))
```
