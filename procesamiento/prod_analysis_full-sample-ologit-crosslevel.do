...
esttab model1 model2 model3 model4 model5 model6 model7, drop(age2 1.class3 2.class3 3.class3 female agenum edyears workst union 1.Q03pcm 2.Q03pcm 3.Q03pcm 4.Q03pcm )

*# Ordinal logit strong ties ---------------------------------------------------
meglm redist c.homclass_s##c.gini_disp i.class3 female agenum age2 edyears i.Q03pcm workst union logrgdpna gini_disp[pweight=WEIGHT] || country2: homclass_s, family(ordinal)
estimates store model1

meglm redist c.homclass_s##c.gini_mkt i.class3 female agenum age2 edyears i.Q03pcm workst union logrgdpna gini_mkt[pweight=WEIGHT] || country2: homclass_s, family(ordinal)
estimates store model2

meglm redist c.homclass_s##c.top10 i.class3 female agenum age2 edyears i.Q03pcm workst union logrgdpna top10[pweight=WEIGHT] || country2: homclass_s, family(ordinal)
estimates store model3

meglm redist c.homclass_s##c.middle50 i.class3 female agenum age2 edyears i.Q03pcm workst union logrgdpna middle50[pweight=WEIGHT] || country2: homclass_s, family(ordinal)
estimates store model4

meglm redist c.homclass_s##c.d10d1 i.class3 female agenum age2 edyears i.Q03pcm workst union logrgdpna d10d1[pweight=WEIGHT] || country2: homclass_s, family(ordinal)
estimates store model5

meglm redist c.homclass_s##c.giniindex i.class3 female agenum age2 edyears i.Q03pcm workst union logrgdpna giniindex[pweight=WEIGHT] || country2: homclass_s, family(ordinal)
estimates store model6

meglm redist c.homclass_s##c.ttheilge1 i.class3 female agenum age2 edyears i.Q03pcm workst union logrgdpna ttheilge1[pweight=WEIGHT] || country2: homclass_s, family(ordinal)
estimates store model7
...
meglm redist c.homclass_w##c.gini_disp i.class3 female agenum age2 edyears i.Q03pcm workst union logrgdpna gini_disp[pweight=WEIGHT] || country2: homclass_w, family(ordinal)
estimates store model1

meglm redist c.homclass_w##c.gini_mkt i.class3 female agenum age2 edyears i.Q03pcm workst union logrgdpna gini_mkt[pweight=WEIGHT] || country2: homclass_w, family(ordinal)
estimates store model2

meglm redist c.homclass_w##c.top10 i.class3 female agenum age2 edyears i.Q03pcm workst union logrgdpna top10[pweight=WEIGHT] || country2: homclass_w, family(ordinal)
estimates store model3

meglm redist c.homclass_w##c.middle50 i.class3 female agenum age2 edyears i.Q03pcm workst union logrgdpna middle50[pweight=WEIGHT] || country2: homclass_w, family(ordinal)
estimates store model4

meglm redist c.homclass_w##c.d10d1 i.class3 female agenum age2 edyears i.Q03pcm workst union logrgdpna d10d1[pweight=WEIGHT] || country2: homclass_w, family(ordinal)
estimates store model5

meglm redist c.homclass_w##c.giniindex i.class3 female agenum age2 edyears i.Q03pcm workst union logrgdpna giniindex[pweight=WEIGHT] || country2: homclass_w, family(ordinal)
estimates store model6

meglm redist c.homclass_w##c.ttheilge1 i.class3 female agenum age2 edyears i.Q03pcm workst union logrgdpna ttheilge1[pweight=WEIGHT] || country2: homclass_w, family(ordinal)
estimates store model7
...
meglm redist c.homclass_res##c.gini_disp i.class3res female agenum age2 edyears i.Q03pcm workst union logrgdpna gini_disp[pweight=WEIGHT] || country2: homclass_res, family(ordinal)
estimates store model1

meglm redist c.homclass_res##c.gini_mkt i.class3res female agenum age2 edyears i.Q03pcm workst union logrgdpna gini_mkt[pweight=WEIGHT] || country2: homclass_res, family(ordinal)
estimates store model2

meglm redist c.homclass_res##c.top10 i.class3res female agenum age2 edyears i.Q03pcm workst union logrgdpna top10[pweight=WEIGHT] || country2: homclass_res, family(ordinal)
estimates store model3

meglm redist c.homclass_res##c.middle50 i.class3res female agenum age2 edyears i.Q03pcm workst union logrgdpna middle50[pweight=WEIGHT] || country2: homclass_res, family(ordinal)
estimates store model4

meglm redist c.homclass_res##c.d10d1 i.class3res female agenum age2 edyears i.Q03pcm workst union logrgdpna d10d1[pweight=WEIGHT] || country2: homclass_res, family(ordinal)
estimates store model5

meglm redist c.homclass_res##c.giniindex i.class3res female agenum age2 edyears i.Q03pcm workst union logrgdpna giniindex[pweight=WEIGHT] || country2: homclass_res, family(ordinal)
estimates store model6

meglm redist c.homclass_res##c.ttheilge1 i.class3res female agenum age2 edyears i.Q03pcm workst union logrgdpna ttheilge1[pweight=WEIGHT] || country2: homclass_res, family(ordinal)
estimates store model7
