...
ggplot(aes(y =estimate,x=n_low, fill=dclass3res_V, color=dclass3res_V,ymin=conf.low, ymax=conf.high,group=dclass3res_V)) +
  # geom_errorbar(alpha=0.8,size=0.5,linetype="solid",color="black") +
  ...
  labs(
    # caption = paste0("Note: N (individuals) = ",nobs(digclas1_VW_11),"; N (countries) = ",lme4::ngrps(digclas1_VW_11),". Predictive estimates with 95% confidence intervals"),
       x="Class-profile low",y="Redistributive preferences",,tag = "A") +
...
ggplot(aes(y =estimate,x=n_middle, fill=dclass3res_V, group=dclass3res_V,ymin=conf.low, ymax=conf.high)) +
  ...
  labs(
    # caption = paste0("Note: N (individuals) = ",nobs(digclas1_VW_11),"; N (countries) = ",lme4::ngrps(digclas1_VW_11),". Predictive estimates with 95% confidence intervals"),
      x="Class-profile Middle",y="Redistributive preferences",tag = "B") +
  theme(legend.position = "none", legend.title = element_blank())
...
ggplot(aes(y =estimate,x=n_high, fill=dclass3res_V, group=dclass3res_V,ymin=conf.low, ymax=conf.high)) +
  ...
  labs(
    # caption = paste0("Note: N (individuals) = ",nobs(digclas1_VW_11),"; N (countries) = ",lme4::ngrps(digclas1_VW_11),". Predictive estimates with 95% confidence intervals",),
       x="Class-profile High",y="Redistributive preferences",tag = "C") +
  theme(legend.position = "none", legend.title = element_blank())
...
# data_socx <- data.table::fread("input/data/original/ocde-socx/ocde-socx.csv")
