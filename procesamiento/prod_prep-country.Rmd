...
```{r pen-data}
pendata<- haven::read_dta(file = "input/data/original/pen-world/pwt1001.dta")
...
df2 <- 
df1 %>% left_join(country_data4[,c("ccode","c3","giniwd","gini_disp","gini_mkt","palmawd","rgdpna")],by = "ccode")
```
