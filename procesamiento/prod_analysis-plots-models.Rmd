...
ggplot(aes(y =estimate,x=homclass, fill=class3, color=class3,ymin=conf.low, ymax=conf.high)) +
  ...
  facet_grid(~factor(class3, levels=c("Working Class (V+VI+VII)","Intermediate class (III+IV)","Service Class (I+II)"),c("Service Class (I+II)","Intermediate class (III+IV+V)","Working Class (VI+VII)"))) +
  labs(caption = paste0("N=",nobs(int_homo),", Countries=",lme4::ngrps(int_homo))) +
