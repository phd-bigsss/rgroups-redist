...
full_int2 <- lmer(redist~1+female+agenum+eindex*isei08+ednum+(1|country),data=dfreg)
models <- list(class,class_status,full,full_int1,full_int2)
texreg::knitreg(full_int2)
