...
wid, indicators(adiinc) areas(AU AT CN TW HR CZ DK EE FI FR DE HU IS IN IL JP LT MX NZ PH RU SK SI ZA ES SR SE CH TH TR GB US) year(2015 2016 2017 2018) perc(p10p100 p0p50 p80p100 p90p100) ages(992) pop(j) clear 
...
egen country_yr = concat(country year), punct(_)  // I separated them by a "-", you can change to whatever you want
bro
gen wid_rd10d01 = valuep90p100/valuep10p100
...
wid, indicators(sdiinc) areas(AU AT CN TW HR CZ DK EE FI FR DE HU IS IN IL JP LT MX NZ PH RU SK SI ZA ES SR SE CH TH TR GB US) year(2016 2017 2018) perc(p10p100 p80p100 p90p100) ages(992) pop(j) clear 
reshape wide value, i(country year) j(percentile) string
