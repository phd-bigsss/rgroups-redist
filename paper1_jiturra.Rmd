...
# Quintile 1 (low)
digclas1_VW_1<- lm(egal~1 + homclass3_V_res +know_total+socialtrust +female+agenum+age2 + partner + religion + factor(country2),data=subset(dfreg,gini_q05==1),weights = WEIGHT)
digclas1_VW_Q1_1 <- update(digclas1_VW_1, . ~ . + dclass3res_V+female+agenum+age2+edyears+ Q03pcm+workst+union+dclass3spo_V)
digclas1_VW_Q1_2 <- update(digclas1_VW_Q1_1, . ~ . +dclass3res_V*homclass3_V_res)

# Quintile 2 (mid-low)
digclas1_VW_1<- lm(egal~1 + homclass3_V_res +know_total+socialtrust +female+agenum+age2 + partner + religion+ factor(country2),data=subset(dfreg,gini_q05==2),weights = WEIGHT)
digclas1_VW_Q2_1 <- update(digclas1_VW_1, . ~ . + dclass3res_V+female+agenum+age2+edyears+ Q03pcm+workst+union+dclass3spo_V)
digclas1_VW_Q2_2 <- update(digclas1_VW_Q2_1, . ~ . +dclass3res_V*homclass3_V_res)

# Quintile 3 (middle)
digclas1_VW_1<- lm(egal~1 + homclass3_V_res +know_total+socialtrust +female+agenum+age2 + partner + religion + factor(country2),data=subset(dfreg,gini_q05==3),weights = WEIGHT)
digclas1_VW_Q03_1 <- update(digclas1_VW_1, . ~ . + dclass3res_V+female+agenum+age2+edyears+ Q03pcm+workst+union+dclass3spo_V)
digclas1_VW_Q03_2 <- update(digclas1_VW_Q03_1, . ~ . +dclass3res_V*homclass3_V_res)

# Quintile 4 (middle-high)
digclas1_VW_1<- lm(egal~1 + homclass3_V_res +know_total+socialtrust +female+agenum+age2 + partner + religion + factor(country2),data=subset(dfreg,gini_q05==4),weights = WEIGHT)
digclas1_VW_Q04_1 <- update(digclas1_VW_1, . ~ . + dclass3res_V+female+agenum+age2+edyears+ Q03pcm+workst+union+dclass3spo_V)
digclas1_VW_Q04_2 <- update(digclas1_VW_Q04_1, . ~ . +dclass3res_V*homclass3_V_res)

# Quintile 5 (high)
digclas1_VW_1<- lm(egal~1 + homclass3_V_res +know_total+socialtrust +female+agenum+age2 + partner + religion + factor(country2),data=subset(dfreg,gini_q05==5),weights = WEIGHT)
digclas1_VW_Q05_1 <- update(digclas1_VW_1, . ~ . + dclass3res_V+female+agenum+age2+edyears+ Q03pcm+workst+union+dclass3spo_V)
...
```{r fig1-marg-ineqgrup, fig.dim=c(10,5),fig.cap='Average Marginal Effects of Network homogeneity conditionated by Social class on Redistributive Preferences by Income Inequality Groups',warning=FALSE}
marginal <- bind_rows(
...
marginal$quintile <- factor(marginal$quintile,labels = c("Q1","Q2","Q3","Q4","Q5"))
