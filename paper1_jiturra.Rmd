...
```{r oldcode2, eval=FALSE, fig.cap='Bivariate relationships between Income Inequality, fig.dim=c(12,5), include=FALSE, Social Class and Network homogeneity',warning=FALSE}
homo_ineq <- dfreg %>%
  # filter(country3 != "ZAF") %>%
  group_by(country2,country3,dclass3res_V) %>%
  summarise_at(c("homclass3_V_res","egal","gini_disp"), mean, na.rm = TRUE) %>% 
